...
/// Mapping <c>mixed</c>/<c>toiletPaper</c> alone resolves to COMMON («Ящик общей поддержки»)
/// or WEAPON crates in GetAirdropCrateItem — so we build SUPPLY + ForcedLoot ourselves.
/// </summary>
